...
const isExportUrl = (url) => url.includes('/api/payroll/11/history/export');
...
const renderPage = () => render(<MySalarySlips />);
...
describe('MySalarySlips', () => {
  ...
  it('shows an empty state when no slips have been generated yet', async () => {
    ...
    expect(await screen.findByText('No salary slips yet')).toBeInTheDocument();
  });
