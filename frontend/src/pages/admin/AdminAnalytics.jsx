...
const ROLE_COLOR = { ADMIN: '#dc3545', EMPLOYER: '#0d6efd', WORKER: '#198754' };
...
export default function AdminAnalytics() {
  ...
  const loadAnalytics = useCallback(async (signal, selectedMonth) => {
    setLoading(true);
    setError('');
    try {
