package com.domesticconnects.payroll.audit;
 ...
 * Usage:
 * <pre>{@code
 * @Auditable(action = "CREATE", entity = "SalaryRecord", detail = "Generate salary slip")
...
public @interface Auditable {
    ...
    /**
     * Entity type, e.g. {@code "SalaryRecord"}. Stored verbatim.
     */
    String entity();
