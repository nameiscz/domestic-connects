...
/**
 * Wire payload published to the {@code salary-slip-generated} Kafka topic.
 * <p>
...
public class NotificationEvent {
    ...
    /** Event kind as a string, e.g. {@code SALARY_SLIP_GENERATED}. */
    private String type;

    /** Human-readable message body stored on the notification. */
    private String message;

    /** Optional id of the originating record (the salary record). */
